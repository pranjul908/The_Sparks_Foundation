...
Hello Folks, I've completed my Testing (Automated) TASK - 6 as a Web Development Intern under GRADUATE ROTATIONAL INTERNSHIP PROGRAM (GRIP) by The Sparks Foundation. In this project I used Selenium to create a test case to test the website thesparksfoundation.sg.
